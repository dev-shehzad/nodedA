        ...
        <div>
            ...
            <div>
                ...
                <div className=' flex justify-center mt-[60px] cursor-pointer'>
                    <Link href="/pages/SignIn" className='px-8 max-sm:px-3 py-2 max-sm:py-1 text-center bg-[#0076BA] hover:bg-[#3d97cb] rounded-full text-white text-md max-sm:text-sm '>Sign in</Link>
                </div>
